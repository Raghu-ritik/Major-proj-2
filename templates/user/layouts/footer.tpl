    ...
    <script src="{$g_base_url}\templates\assets/js/jquery.slimscroll.js"></script>
    <script src="{$g_base_url}\templates\assets/js/custom.min.js"></script>
    <script src="{$g_base_url}\templates\assets/js/sidebarmenu.js"></script>
